...
runuser -l $userName -c "git clone https://aur.archlinux.org/yay && cd yay && makepkg -si --noconfirm && cd .. && sudo rm -rf yay && yay -S --noconfirm nerd-fonts-mononoki ttf-material-design-icons brave-bin"
...
runuser -l $username -c "curl https://liveemily.xyz/archieinstall/wallpaper.png --output /home/emily/wallpaper.png"
